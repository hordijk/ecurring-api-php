...
class InvoiceLine extends AbstractResource
{
    ...
    {
        //  TODO the name for some of the properties differ with the returned values.
        // Therefore we cannot use toArray, (which uses properties defined in exportProperties
