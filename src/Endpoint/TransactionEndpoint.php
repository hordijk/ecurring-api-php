...
use Mooore\eCurring\Resource\TransactionCollection;

class TransactionEndpoint extends AbstractCollectionEndpoint
{
    ...
    {
        return new TransactionCollection($this->client, $this->resourceFactory, $count, $links);
    }
